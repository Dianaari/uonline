...
?>
    ...
    <div class="panel panel-success"> 
        ...
        <?php echo $this->session->flashdata('pesan'); ?> 
            <form action="<?php echo site_url('Admin/siswa/edit').'/'.$editdata[0]['nis']?>" method="post">
                <table class="table table-striped">
                    <tr> 
                        <td>NIS</td>
                        <td><div class="col-sm-6"> 
                                    <input type="text" name="nis" placeholder="NIS" required="requreid" class="select2 form-control" value="<?php echo $editdata[0]['nis'] ?>" readonly="readonly">
                                </div>
                        </td> 
                    </tr> 
                    <tr>
                    ...
                    <tr> 
                        ...
                        <td><div class="col-md-6">
                                <select class="select2 form-control" name="jenkel" required="requreid">
                                    <option><?php echo $editdata[0]['jenkel'];?></option>
                    ...
                    <tr> 
                        <td>Username</td> 
                        <td><div class="col-sm-6"> 
                                    <input type="text" name="username" placeholder="username" required="requreid" class="form-control" value="<?php echo $editdata[0]['username'] ?>" readonly="readonly">
                                </div></td> 
                    </tr>  
                    ...
                    <tr> 
                        <td>Password</td> 
                        <td><div class="col-sm-6"> 
                                    <input type="text" name="password" placeholder="password" required="requreid" class="form-control" value="<?php echo $editdata[0]['password'] ?>" readonly="readonly">
                                </div></td> 
                    </tr>  
                    <tr> 
                        <td>Level</td> 
