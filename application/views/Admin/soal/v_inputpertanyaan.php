...
?>
    ...
    <div class="panel panel-success"> 
        ...
        <?php echo $this->session->flashdata('Pesan'); ?> 
            <form action="<?php echo site_url('Admin/pertanyaan/input/'. $id_soal)?>" method="post" enctype="multipart/form-data" />
           <?php echo form_open_multipart('Admin/pertanyaan/input/'.$id_soal);  ?>
