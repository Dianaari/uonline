...
<html lang="en">
   <head>
      <meta charset="utf-8">
      <title>Dashboard - Sistem Ujian Online Smansago</title>
      ...
      <script src="<?php echo base_url(); ?>assets/plugin/countdown/jquery.countdown.js"></script> 
   ...
   <div class="" style="min-height: 450px">
      <nav class="navbar navbar-findcond navbar-fixed-top">
         <div class="container">
            ...
            <a class="navbar-brand" href="<?php echo base_url('index.php/home/indexSiswa');?>">Sistem Ujian Online Smansago</a>
            </div>
               ...
               <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo base_url('index.php/Siswa/password_s/index');?>" onclick="">Ubah Password</a></li>
                        <li><a href="<?php echo base_url('index.php/login/logout');?>" onclick="return confirm('keluar..?');">Logout</a></li>
                     </ul>
                  </li>
               </ul>
            </div>
