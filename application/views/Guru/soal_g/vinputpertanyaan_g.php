...
?>
    ...
    <div class="panel panel-success"> 
        <div class="panel-heading">
           <h1 class="panel-title">Input Pertanyaan</h1>
        </div>

        <div class="panel-body">
        <?php echo $this->session->flashdata('Pesan'); ?> 
            <form action="<?php echo site_url('Guru/cpertanyaan_g/input/'. $id_soal)?>" method="post" enctype="multipart/form-data" />
           <?php echo form_open_multipart('Guru/cpertanyaan_g/input/'.$id_soal);  ?>
              ...
              <div class="form-group fgsoal">
                  <div class="col-lg-2"><label>Tipe Pertanyaan</label> </div>
                      ...
                      <div class="col-lg-3">
                          <input type="radio" name="jenis_pertanyaan" class="type" value="Multiple" > 
              ...
              <div class="form-group fgsoal">
                <div class="col-md-2"><label>Teks Pertanyaan</label></div>
                    ...
                    <div class="col-md-7">
                        <textarea class="form-control" id="editornya" style="height: 30px;" name="pertanyaan"> </textarea>
                    </div>
              </div>
              <br><br>
              ...
              <div class="form-group fgsoal opsi">
                <div class="col-md-2"><label>Opsi A</label></div>
                  ...
                  <div class="col-md-7">
                        <textarea class="form-control" id="editornya_a" style="height: 30px" name="isi_opsi[]"> </textarea>
                  </div>
              </div>
              ...
              <div class="form-group fgsoal opsi">
                <div class="col-md-2"><label>Opsi B</label></div>
                  ...
                  <div class="col-md-7">
                        <textarea class="form-control" id="editornya_b" style="height: 30px" name="isi_opsi[]"> </textarea>
                  </div>
              </div>
              ...
              <div class="form-group fgsoal opsi">
                <div class="col-md-2"><label>Opsi C</label></div>
                  ...
                  <div class="col-md-7">
                        <textarea class="form-control" id="editornya_c" style="height: 30px" name="isi_opsi[]"> </textarea>
                  </div>
              </div>
              ...
              <div class="form-group fgsoal opsi">
                <div class="col-md-2"><label>Opsi D</label></div>
                  ...
                  <div class="col-md-7">
                        <textarea class="form-control" id="editornya_d" style="height: 30px" name="isi_opsi[]"> </textarea>
                  </div>
              </div>
              ...
              <div class="form-group fgsoal opsi">
                <div class="col-md-2"><label>Opsi E</label></div>
                  ...
                  <div class="col-md-7">
                        <textarea class="form-control" id="editornya_e" style="height: 30px" name="isi_opsi[]"> </textarea>
                  </div>
              </div>
 ...
 -->
            ...
            <div class="form-group" style="margin-top: 20px">
              <div class="col-md-12">
                ...
                <a href="<?php echo site_url('Guru/cpertanyaan_g/index')?>" class="btn btn-default"><i class="fa fa-minus-circle"></i> Kembali</a>
              </div>
            </div>
