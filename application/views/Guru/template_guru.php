   ...
   <div class="" style="min-height: 450px">
      <nav class="navbar navbar-findcond navbar-fixed-top">
         <div class="container">
            ...
            <a class="navbar-brand" href="<?php echo base_url('index.php/home/indexGuru');?>">Sistem Ujian Online Smansago</a>
            </div>
               ...
               <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                     ...
                     <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo base_url('index.php/Guru/password/index');?>" onclick="">Ubah Password</a></li>
